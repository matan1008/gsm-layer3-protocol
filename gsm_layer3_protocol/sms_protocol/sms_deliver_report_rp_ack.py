...
class RpAckSmsDeliverReport(Container):
    def __init__(self, tp_pid=None, tp_dcs=None, tp_ud=None):
        tp_pi = {
        ...
        super().__init__(tp_mti=tp_mti_enum.SMS_DELIVER_OR_REPORT, tp_udhi=tp_udhi, tp_pi=tp_pi,
                         tp_pid=tp_pid, tp_dcs=tp_dcs, tp_ud=tp_ud)


sms_deliver_report_tpdu_struct = BitStruct(
    Padding(1),
