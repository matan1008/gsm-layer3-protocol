...
class SmsStatusReport(Container):
    def __init__(self, tp_srq, tp_lp, tp_mms, tp_mr, tp_ra, tp_scts, tp_dt,
                 tp_st, tp_pid=None, tp_dcs=None, tp_ud=None):
        tp_pi = {
        ...
        super().__init__(tp_mti=tp_mti_enum.SMS_STATUS_OR_COMMAND,
                         tp_mms=tp_mms, tp_lp=tp_lp, tp_srq=tp_srq,
                         tp_udhi=tp_udhi, tp_mr=tp_mr, tp_ra=tp_ra,
                         tp_scts=tp_scts, tp_dt=tp_dt, tp_st=tp_st,
                         tp_pi=tp_pi, tp_pid=tp_pid, tp_dcs=tp_dcs,
                         tp_ud=tp_ud)
...
sms_status_report_tpdu_struct = BitStruct(
    ...
    "tp_mti" / Const(tp_mti_enum.SMS_STATUS_OR_COMMAND,
                     tpdu_parameters.tp_mti),
    "tp_mr" / tpdu_parameters.tp_mr,
    "tp_ra" / Bytewise(tpdu_parameters.tp_ra),
